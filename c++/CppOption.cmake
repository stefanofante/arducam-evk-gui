if (NOT DEFINED CPP_CMAKE_OPTION)
    ...
    # Default configuration file used when the demos are launched without arguments.
    # Points to the bundled Mira220 cfg in the python/ folder of the repository.
    get_filename_component(_EVK_REPO_ROOT "${CMAKE_CURRENT_LIST_DIR}/.." ABSOLUTE)
    if(NOT DEFINED DEFAULT_CONFIG_FILE)
        set(DEFAULT_CONFIG_FILE "${_EVK_REPO_ROOT}/Mira220_MIPI_2Lane_640x480_12b_80fps.cfg"
            CACHE FILEPATH "Default camera configuration file used when no CLI arg is provided")
    endif()
    ...
    if(NOT DEFINED arducam_evk_cpp_sdk_FOUND)
        ...
        if(WIN32)
            ...
            function(copy_dll_to TARGET_NAME)
                ...
                # Copy any extra DLLs registered via EXTRA_DLL_DEPS (e.g. OpenCV)
                if(DEFINED EXTRA_DLL_DEPS AND EXTRA_DLL_DEPS)
                    add_custom_command(TARGET ${TARGET_NAME} POST_BUILD
